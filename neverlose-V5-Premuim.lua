...
function Library:CreateWindow()
    ...
    local Icon = Instance.new("Frame", Logo)
    ...
    Title.Position = UDim2.new(0, 55, 0, 22)
    Title.Font = Enum.Font.GothamBold
    Title.TextColor3 = Theme.Text
    Title.TextSize = 16
    Title.TextXAlignment = Enum.TextXAlignment.Left
    Title.BackgroundTransparency = 1
    local SubLogo = Instance.new("TextLabel", Logo)
    SubLogo.Text = "Roblox"
    SubLogo.Position = UDim2.new(0, 55, 0, 38)
    SubLogo.Font = Enum.Font.Gotham
    SubLogo.TextColor3 = Theme.Muted
    SubLogo.TextSize = 11
...
function E:AddToggle(txt, callback)
    ...
    local L = Instance.new("TextLabel", F); L.Text = txt; L.Size = UDim2.new(1, 0, 1, 0); L.Font = Enum.Font.GothamMedium; L.TextColor3 = Theme.Text; L.TextSize = 14; L.TextXAlignment = Enum.TextXAlignment.Left; L.BackgroundTransparency = 1
...
function E:AddSlider(txt, min, max, suffix, callback)
    ...
    local L = Instance.new("TextLabel", F); L.Text = txt; L.Size = UDim2.new(0.6, 0, 0, 18); L.Font = Enum.Font.GothamMedium; L.TextColor3 = Theme.Text; L.TextSize = 14; L.TextXAlignment = Enum.TextXAlignment.Left; L.BackgroundTransparency = 1
    local V = Instance.new("TextLabel", F); V.Text = tostring(min)..suffix; V.Size = UDim2.new(0.4, 0, 0, 18); V.Position = UDim2.new(0.6,0,0,0); V.Font = Enum.Font.GothamMedium; V.TextColor3 = Theme.Accent; V.TextSize = 13; V.TextXAlignment = Enum.TextXAlignment.Right; V.BackgroundTransparency = 1
...
function E:AddDropdown(txt, options, callback)
    ...
    local L = Instance.new("TextLabel", F); L.Text = txt; L.Size = UDim2.new(0.5, 0, 1, 0); L.Font = Enum.Font.GothamMedium; L.TextColor3 = Theme.Text; L.TextSize = 14; L.TextXAlignment = Enum.TextXAlignment.Left; L.BackgroundTransparency = 1
    ...
    ValTxt.Size = UDim2.new(1, -10, 1, 0); ValTxt.Position = UDim2.new(0, 5, 0, 0); ValTxt.BackgroundTransparency = 1; ValTxt.Text = options[1] or ""; ValTxt.Font = Enum.Font.GothamMedium; ValTxt.TextColor3 = Color3.new(1,1,1); ValTxt.TextSize = 12; ValTxt.TextXAlignment = Enum.TextXAlignment.Left; ValTxt.ZIndex = 100
    ...
    Box.MouseButton1Click:Connect(function()
        ...
        for _, opt in pairs(options) do
            ...
            oBtn.Size = UDim2.new(1,0,0,28); oBtn.BackgroundColor3 = Theme.Element; oBtn.Text = "  "..opt; oBtn.Font = Enum.Font.GothamMedium; oBtn.TextColor3 = Theme.Text; oBtn.TextSize = 13; oBtn.TextXAlignment = Enum.TextXAlignment.Left; oBtn.BorderSizePixel = 0
...
function E:AddArrow(txt, callback)
   local F = Instance.new("Frame", Container); F.Size = UDim2.new(1, 0, 0, 24); F.BackgroundTransparency = 1
   local L = Instance.new("TextLabel", F); L.Text = txt; L.Size = UDim2.new(1, 0, 1, 0); L.Font = Enum.Font.GothamMedium; L.TextColor3 = Theme.Text; L.TextSize = 14; L.TextXAlignment = Enum.TextXAlignment.Left; L.BackgroundTransparency = 1
   local A = Instance.new("TextButton", F); A.Size = UDim2.new(0, 20, 1, 0); A.Position = UDim2.new(1, 0, 0, 0); A.AnchorPoint = Vector2.new(1,0); A.BackgroundTransparency = 1; A.Text = ">"; A.Font = Enum.Font.GothamBold; A.TextColor3 = Theme.Muted; A.TextSize = 16
